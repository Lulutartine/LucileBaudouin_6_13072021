 ...
 * @property {string[]} images path pics to Lightbox
 * @property {string} url curent pic displayed
 */
export class lightbox {
	//____________________INIT LIGHTBOX____________________//
	...
	//*********CONSTRUCTOR**********//
	/**
	 * @param {string} url pics url
	 * @param {string[]} images path pics to Lightbox
	 */
